export default function ProcessingRulesPage() {
  return (
    <div className="p-8 max-w-2xl">
      <h1 className="text-2xl font-semibold text-gray-900 mb-4">Processing Rules</h1>
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-6">
        <p className="text-amber-800 font-medium mb-2">This feature has been replaced by the Workflow Engine.</p>
        <p className="text-amber-700 text-sm">
          Processing rules are now configured as AUTO_RULE steps inside workflow templates
